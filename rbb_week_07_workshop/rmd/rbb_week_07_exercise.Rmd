...
Use `left_join()` to add this to your `hiv_data_combined` variable (the HIV data combined should be the left or primary dataset). You should use both "country_code" and "year" as keys.
...
### Plot Incidence and Prevalence Rates for Selected Countries

Select 3 countries of your choice and plot both the incidence rate and prevalence rate over time for them.
...
3. **Identify Highest Prevalence Rates:** Find the countries with the highest prevalence rate in 2011 for each continent.
4. **Create a Bar Chart:** Make a bar chart comparing the 2011 prevalence rates of these countries.

```{r optional-challenge}
# Your code here
```
