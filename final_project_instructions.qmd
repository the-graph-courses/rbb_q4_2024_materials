...
Your choice of topic is entirely up to you. One common theme is to pick a specific variable of interest (e.g. a speciic family planning behavior), then show how that varies across socio-demographic groups (e.g. age, education, wealth, etc.).
